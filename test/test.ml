...
let test () =
  ...
  let bna = degree_coordinate_of_floats 36.12 (-86.67) in
  let lax = degree_coordinate_of_floats 33.94 (-118.4) in
  ...
  let jak = degree_coordinate_of_floats (-6.21462) 106.84513 in
  let bdg = degree_coordinate_of_floats (-6.90389) 107.61861 in
